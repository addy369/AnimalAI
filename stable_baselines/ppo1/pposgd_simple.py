...
class PPO1(ActorCriticRLModel):
    ...
    def __init__(self, policy, env, gamma=0.99, timesteps_per_actorbatch=256, clip_param=0.2, entcoeff=0.01,
                 ...
                 schedule='linear', verbose=1, tensorboard_log=None, _init_setup_model=True,
    ...
    def setup_model(self):
        with SetVerbosity(self.verbose):
            ...
            with self.graph.as_default():
                ...
                self.policy_pi = self.policy(self.sess, self.observation_space, self.action_space, self.n_envs, 256,
