...
class A2C(ActorCriticRLModel):
    ...
    def _get_pretrain_placeholders(self):
        ...
        if isinstance(self.action_space, gym.spaces.Discrete):
            return policy.obs_ph, self.actions_ph, states_ph, snew_ph, masks_ph, policy.policy
        return policy.obs_ph, self.actions_ph, states_ph, snew_ph, masks_ph, policy.deterministic_action
