...
class PPO2(ActorCriticRLModel):
    ...
    def __init__(self, policy, env, gamma=0.99, n_steps=128, ent_coef=0.01, learning_rate=2.5e-4, vf_coef=0.5,
                 ...
                 verbose=1, tensorboard_log='/tmp', _init_setup_model=True, policy_kwargs=None,
        ...
        print('Path where tensorboard logs are stored: {}', tensorboard_log)
    ...
    def _get_pretrain_placeholders(self):
        ...
        return policy.obs_ph, self.action_ph, states_ph, snew_ph, dones_ph, policy.deterministic_action
        ...
        with SetVerbosity(self.verbose):
            ...
            with self.graph.as_default():
                ...
                act_model = self.policy(self.sess, self.observation_space, self.action_space, self.n_envs, 1,
                                        None, reuse=False, **self.policy_kwargs) #n_batch_step
                with tf.variable_scope("train_model", reuse=True,
                                       custom_getter=tf_util.outer_scope_getter("train_model")):
                    #print(self.n_envs // self.nminibatches, self.n_steps, n_batch_train)
                    train_model = self.policy(self.sess, self.observation_space, self.action_space,
                                              self.n_envs // self.nminibatches, self.n_steps, None,
                                              reuse=True, **self.policy_kwargs) #n_batch_train
